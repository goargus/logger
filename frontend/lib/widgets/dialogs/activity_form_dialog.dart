...
class _ActivityFormDialogState extends State<ActivityFormDialog> {
  ...
  bool get isEditMode => widget.existingActivity != null;

  String get _activityId => widget.existingActivity?['id'] ?? '';
  ...
  Widget build(BuildContext context) {
    ...
    final dialogTitle = isEditMode ? 'Editar actividad' : 'Crear actividad';
    final submitLabel = isEditMode ? 'Actualizar' : 'Guardar';
